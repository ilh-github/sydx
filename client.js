                ...
                if (identityNumber.length > 0) {
                    if ($("input[type='password']")[0]) {
                        setTimeout(function () {
                            ...
                            $("#app > div > div.center > div > div:nth-child(1) > a.qm-big-text.login-type.active-type").removeClass("active-type");
                            $("#app > div > div.center > div > div:nth-child(1) > a:nth-child(2)").addClass("active-type");


                            window.inputValue($("input[type='text']")[0], identityNumber);
